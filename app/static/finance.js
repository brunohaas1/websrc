...
async function loadAll(options = {}) {
  ...
  try {
    ...
    _scheduleDeferred(async () => {
      ...
      const selectedStatus = String(byId("finCashflowStatus")?.value || "").trim();
...
async function refreshCashflowPanel() {
  ...
  const paymentStatus = String(byId("finCashflowStatus")?.value || "").trim();
...
// Cashflow helpers/rendering moved to app/static/finance_cashflow.js.
...
// Cashflow modals/actions moved to app/static/finance_cashflow.js.

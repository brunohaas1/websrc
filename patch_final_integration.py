#!/usr/bin/env python3
# Final HTML integration and test file

# 1. Update HTML
with open('app/templates/finance.html', 'r', encoding='utf-8') as f:
    html = f.read()

if '<script src="/static/finance_advanced.js"></script>' in html:
    html = html.replace(
        '<script src="/static/finance_advanced.js"></script>',
        '<script src="/static/finance_final_features.js"></script>\n  <script src="/static/finance_advanced.js"></script>'
    )
    with open('app/templates/finance.html', 'w', encoding='utf-8') as f:
        f.write(html)
    print("✓ Integrated final features JS into HTML")
...
with open('tests/test_features_integration.py', 'w', encoding='utf-8') as f:
